                    ...
                    case FileType.Excel:
                        {
                            ...
                            worksheet.Cells[1, 2].Value = "Общее термическое сопротивление";
                            worksheet.Cells[2, 2].Value = "Rl, (м*К)/Вт";
                            worksheet.Cells[3, 2].Value = reportData.Rl;

                            worksheet.Cells[1, 3].Value = "Линейный коэффициент теплопередачи";
                            worksheet.Cells[2, 3].Value = "kl, Вт/(м*К)";
                            worksheet.Cells[3, 3].Value = reportData.kl;
                            ...
                            for (var j = 5; j < 5 + reportData.Temperatures.Count; j++)
                                worksheet.Cells[3, j].Value = reportData.Temperatures[j - 5];
